...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='face_recog',
  syntax='proto3',
  serialized_pb=_b('\n\nface.proto\x12\nface_recog\"%\n\x0fIdentifyRequest\x12\x12\n\nimage_path\x18\x01 \x01(\t\"%\n\x10IdentifyResponse\x12\x11\n\tperson_id\x18\x01 \x01(\x05\x32S\n\x08Identify\x12G\n\x08Identify\x12\x1b.face_recog.IdentifyRequest\x1a\x1c.face_recog.IdentifyResponse\"\x00\x62\x06proto3')
)
...
_IDENTIFYREQUEST = _descriptor.Descriptor(
  ...
  full_name='face_recog.IdentifyRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='image_path', full_name='face_recog.IdentifyRequest.image_path', index=0,
...
_IDENTIFYRESPONSE = _descriptor.Descriptor(
  ...
  full_name='face_recog.IdentifyResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='person_id', full_name='face_recog.IdentifyResponse.person_id', index=0,
...
IdentifyRequest = _reflection.GeneratedProtocolMessageType('IdentifyRequest', (_message.Message,), dict(
  ...
  __module__ = 'face_pb2'
  # @@protoc_insertion_point(class_scope:face_recog.IdentifyRequest)
  ))
...
IdentifyResponse = _reflection.GeneratedProtocolMessageType('IdentifyResponse', (_message.Message,), dict(
  ...
  __module__ = 'face_pb2'
  # @@protoc_insertion_point(class_scope:face_recog.IdentifyResponse)
  ))
...
_IDENTIFY = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Identify',
    full_name='face_recog.Identify.Identify',
    index=0,
